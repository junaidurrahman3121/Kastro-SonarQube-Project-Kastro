pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'junaidurrahman'  // Set this directly to your Docker Hub username
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/junaidurrahman3121/Kastro-SonarQube-Project-Kastro.git'
            }
        }
